...
test('preserves task orchestration child values when parent is disabled and re-enabled', () => {
  ...
  const previousValue = {
    ...
    inline_strategy_prompt: '<strategy_guidelines>inline</strategy_guidelines>',
    sequential_subagent_strategy_prompt: '<strategy_guidelines>sequential</strategy_guidelines>',
    async_teams_strategy_prompt: '<strategy_guidelines>teams</strategy_guidelines>',
    custom_strategy_prompt: '<strategy_guidelines>custom</strategy_guidelines>',
    mode: 'task_system',
