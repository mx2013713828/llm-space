  ...
  assert.deepEqual(
    ...
    [
      ...
      'GET /api/harnesses/:harnessId/knowledge-bases',
			'GET /api/harnesses/:harnessId/knowledge-runtime',
      'GET /api/harnesses/:harnessId/mcp',
      'GET /api/health',
      ...
      'GET /api/mcp/presets',
      'GET /api/mcp/servers',
      'GET /api/mcp/servers/:serverId/calls',
      ...
      'PATCH /api/knowledge-bases/:knowledgeBaseId',
			'PATCH /api/harnesses/:harnessId/knowledge-runtime',
      ...
      'POST /api/knowledge-bases/test-rerank',
      ...
      'POST /api/mcp/servers/:serverId/test-tool',
